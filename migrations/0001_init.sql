...
-- ------------------------------------------------------------
-- Trending YouTube (statistici oficiale, preluate de cron cu
-- videos.list chart=mostPopular, regionCode=RO, category Autos)
-- ------------------------------------------------------------
...
INSERT INTO categories (slug, name, description, playlist_id, icon, sort_order, default_product_url, accent, seo_title, seo_description, faq_json) VALUES
    ('garage-equipment', 'Echipament Garaje Detailing',
     ...
     NULL, '🔧', 1, 'https://cleanx.ro/echipamente-detailing', '#4cc9e6',
    ...
    ('garage-lighting', 'Iluminat Garaje',
     ...
     NULL, '💡', 2, 'https://cleanx.ro/iluminat-led-garaj', '#e0b45f',
    ...
    ('detailing-products', 'Produse Detailing',
     ...
     NULL, '🧴', 3, 'https://cleanx.ro/produse-detailing', '#7a6ad8',
    ...
    ('microfiber', 'Prosoape Microfibră',
     ...
     NULL, '🧽', 4, 'https://cleanx.ro/prosoape-microfibra', '#57c98a',
    ...
    ('carbon-fiber', 'Fibră Carbon',
     ...
     NULL, '◼️', 5, 'https://cleanx.ro/fibra-carbon-auto', '#8d9de0',
    ...
    ('forged-carbon', 'Tocătură Carbon',
     ...
     NULL, '💠', 6, 'https://cleanx.ro/tocatura-carbon', '#b85c8e',
    ...
    ('ceramic-coating', 'Protecții Ceramice',
     ...
     NULL, '🛡️', 7, 'https://cleanx.ro/protectii-ceramice', '#4cc9e6',
    ...
    ('interior', 'Interior Auto',
     ...
     NULL, '💺', 8, 'https://cleanx.ro/interior-auto', '#e0a35c',
    ...
    ('exterior', 'Exterior Auto',
     ...
     NULL, '🚘', 9, 'https://cleanx.ro/exterior-auto', '#7a6ad8',
    ...
    ('unboxing', 'Unboxing & Review-uri',
     ...
     NULL, '📦', 10, 'https://cleanx.ro/produse-detailing', '#b85c8e',
...
--   CREATE TABLE yt_trending (youtube_id TEXT PRIMARY KEY, title TEXT NOT NULL,
--     thumbnail_url TEXT, channel_title TEXT, views INTEGER DEFAULT 0,
--     published_at DATETIME, rank INTEGER DEFAULT 0,
--     fetched_at DATETIME DEFAULT CURRENT_TIMESTAMP);
